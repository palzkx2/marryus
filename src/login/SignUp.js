            ...
            <div style={{display:'flex', justifyContent:'center', alignContent:'center'}}>
                <div style={{width:'1400px', height:'700px', background:'#FFF0F5'}}>
                    ...
                    <div style={{width:'1250px', height:'120px', background:'white', margin:'0 70px 0 70px', border:'1px solid black', overflowY:'auto'}}>
                        ...
                        <p style={{fontWeight:'bold', padding:'10px', marginBottom:'5px'}}>수집하는 개인정보 항목</p>
                            <p style={{paddingLeft:'25px', fontSize:'8pt', marginBottom:'0'}}>회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
                            <p style={{paddingLeft:'25px', fontSize:'8pt', marginBottom:'0'}}>ο 수집항목 : 이름 , 비밀번호 , 전화번호 , 이메일 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보</p>
                            <p style={{paddingLeft:'25px', fontSize:'8pt', marginBottom:'0'}}>ο 개인정보 수집방법 : 홈페이지(회원가입,이벤트신청,서비스문의,게시판,견적비교)</p>
                    </div>
                    <div style={{alignContent:'end', display:'flex', justifyContent:'end', marginRight:'80px', marginTop:'10px'}}>
                        <input type='checkbox' style={{marginTop:'3px'}}/> 위 약관에 동의합니다.
                    </div>
